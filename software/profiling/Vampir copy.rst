...
.. raw:: html
   ...
   <p>This recording is from the Frontier Training Workshop (August 2023); Friday, August 25th, 2023; Presented by Bill Williams, TU-Dresden. 
   This video gives an introduction to Score-P and Vampir, which are often used together to collect performance profiles/traces from an application and visualize the results.</p>
